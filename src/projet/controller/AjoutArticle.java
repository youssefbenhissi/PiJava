...
public class AjoutArticle implements Initializable{
    ...
    private static final String EMAIL_SUBJECT = "Article Publié";
    private static final String EMAIL_TEXT = "<h1>Votre Article est publié</h1>";
   ...
   EventHandler<ActionEvent> typeeven = (ActionEvent e) -> {
    ...
    public void displayTray(String msg) throws AWTException {
        ...
        trayIcon.displayMessage("Ajout Article", msg, MessageType.INFO);
         ...
         @FXML
            public void handleImage(ActionEvent event) throws ProtocolException, IOException {
...
try {
 ...
 FileUploader fu = new FileUploader("http://127.0.0.1:8000/assets/images/");
        ...
        String fileNameInServer = fu.upload(file.getAbsolutePath());
                   this.Image_Article =  "uploads/" + fileNameInServer;
     ...
     //System.out.println(article);
        ...
        try {
			...
			// HTML email
                        ...
                        InputStream is = new FileInputStream("src\\projet\\views\\article_pub.html");
...
String fileAsString = sb.toString();
            ...
            msg.setDataHandler(new DataHandler(new AjoutArticle.HTMLDataSource(fileAsString)));
