    ...
    public void handleClicks(ActionEvent actionEvent) throws IOException {
      ...
      if (actionEvent.getSource() == btntags) {
        ...
        if(actionEvent.getSource()==Ajout)
        {
            ...
            Pane newLoadedPane =  FXMLLoader.load(getClass().getResource("/projet/views/AjouterCategorie.fxml"));
      ...
      // pnItems.getChildren().clear();
        ...
        for (int i = 0; i < nodess.length  ; i++) {
            ...
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/projet/views/Itemcat.fxml"));
