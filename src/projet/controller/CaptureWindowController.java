...
public class CaptureWindowController implements Initializable {
    ...
    private void snap(ActionEvent event) {
        ...
        run=false ;
        try {
            ImageIO.write(cam.getImage(),"PNG",new File("C:/xampp/htdocs/image/"+user.getEmail()+"Capture.png"));
    ...
    private void Validate(ActionEvent event) {
        Utilisateur user = UserSession.getInstace().getUser();
        TakenImage=new File("C:/xampp/htdocs/image/"+user.getEmail()+"Capture.png");
         
        user.setImage("C:/xampp/htdocs/image/"+user.getEmail()+"Capture.png");
