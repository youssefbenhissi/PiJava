...
public class CaptureWindowController implements Initializable {
    ...
    private void snap(ActionEvent event) {
        ...
        run=false ;
        try {
            ImageIO.write(cam.getImage(),"PNG",new File("C:\\Users\\youssef\\PhpstormProjects\\pidevFinal\\web\\assets\\images\\"+user.getEmail()+"Capture.png"));
    ...
    private void Validate(ActionEvent event) {
        user = service.selectUser(8);
        TakenImage=new File("C:\\Users\\youssef\\PhpstormProjects\\pidevFinal\\web\\assets\\images\\"+user.getEmail()+"Capture.png");
         
        user.setImage("C:\\Users\\youssef\\PhpstormProjects\\pidevFinal\\web\\assets\\images\\"+user.getEmail()+"Capture.png");
