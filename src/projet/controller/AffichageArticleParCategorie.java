 ...
 * @author geek alaa
 */
public class AffichageArticleParCategorie implements Initializable{
...
public void AffichParCat(int id){
      GestionArticles gst = new GestionArticles();
       ...
       for (int i = 0; i < listarticles.size()  ; i++) {
            try {
                if(listarticles.get(i).getCat_id() == id && listarticles.get(i).getType() != 0){
               ...
               Affich.SetArticleID(listarticles.get(i).getId());
                ...
                this.CategorieNom.setText("Catégorie : "+listCat.get(index).getNom());
