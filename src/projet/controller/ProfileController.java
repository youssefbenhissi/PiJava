   ...
   // TextField yourTextField = new TextField();
    ...
    private void Modifier(ActionEvent event) {
       ...
       try {
            ...
            if(!user.getImage().equals("C:/xampp/htdocs/image/"+user.getEmail()+selectedFile.getName()))
            {File image= new File("C:/xampp/htdocs/image/"+user.getEmail()+selectedFile.getName());
            Files.copy(selectedFile.toPath(), image.toPath());}
            user.setImage("C:/xampp/htdocs/image/"+user.getEmail()+selectedFile.getName());
            }
