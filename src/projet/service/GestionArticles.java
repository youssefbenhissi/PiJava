...
this.UpdateListArticles();
    return true;
      ...
      public List<Commentaires> GetCommentaires(int id){
         
         String sql = "SELECT * FROM article_commentaires WHERE article_commentaires.id_article =?";
...
while (result.next()){
    ...
    String contenu = result.getString("contenu");
    Commentaires comm = new Commentaires(email, contenu);
    listCommentaireArticle.add(comm);
}
 
       return listCommentaireArticle;
       } catch (SQLException ex) {
           System.out.println("Une erreur est survenue ! ");  
            //ex.printStackTrace();
        }
        return listCommentaireArticle;
         ...
         public boolean addComm(String email,int id_article,String contenu){
       String sql = "INSERT INTO article_commentaires (email, 	id_article, contenu) VALUES (?, ?, ?)";
    PreparedStatement statement;
        try 
        {
        statement = conn.prepareStatement(sql);
      ...
      public boolean DeleteComm(String email,int id_article){
       String sql = "DELETE FROM article_commentaires WHERE article_commentaires.email =? AND article_commentaires.id_article =?";
    PreparedStatement statement;
        try 
        {
        statement = conn.prepareStatement(sql);
       ...
       public boolean UpdateComm(String email,int id_article,String contenu){
          String sql = "UPDATE article_commentaires SET contenu=? WHERE id_article=? AND email=?";
PreparedStatement statement;
        try 
        {
    statement = conn.prepareStatement(sql);
