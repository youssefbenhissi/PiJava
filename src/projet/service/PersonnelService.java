    ...
    public List<Personnel> selectAllPersonnel(){
        ...
        try {
            ...
            while (rs.next()) {
                ...
                pe.setBtn_delete(new Button("Supprimer"));
...
public void ajouterPersonnel(Personnel pe) {
    System.out.println("nom"+pe.getNom());
    System.out.println("prenom"+pe.getPrenom());
    System.out.println("date"+pe.getDate_debutTravail());
    System.out.println("saolde"+pe.getSoldeConge());
    System.out.println("type"+pe.getType());
    System.out.println("description"+pe.getDescription());
    System.out.println("image"+pe.getImage());
        String requete = "INSERT INTO personnel (nom,prenom,dateDebTravail,soldeConge,type,description,image)"
                + " VALUES ('" + pe.getNom() + "','" + pe.getPrenom() + "','" + pe.getDate_debutTravail() + "','" + pe.getSoldeConge() + "','" + pe.getType() + "','" + pe.getDescription() + "','" + pe.getImage() + "');";
