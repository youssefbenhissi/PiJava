...
public class QrCodeMailApi {
    ...
    public static void envoyerQrCode(String nomEvenement,Date dateDebutEvenement) {
        ...
        String toEmail = "youssef.benhissi@esprit.tn";
        ...
        try {
            ...
            msg.setSubject("Bienvenue à notre Evenement ' " + nomEvenement );
            ...
            try {
                String qrCodeData =  
                        " '  ceci votre ticket vous avez participé à l\'événement : ' " + nomEvenement + 
                        " Date debut sera : '"+ dateDebutEvenement +
                        " \nTicket recu le :" + Timestamp.valueOf(LocalDateTime.now());
                
                
                String filePath = "C:\\Users\\youssef\\Desktop\\qrGenerated.png";
            ...
            try {
                ...
                qrCode.attachFile("C:\\Users\\youssef\\Desktop\\qrGenerated.png");
